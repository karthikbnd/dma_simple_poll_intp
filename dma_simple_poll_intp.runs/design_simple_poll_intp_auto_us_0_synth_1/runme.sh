...
HD_PWD='C:/Users/kab/Desktop/workspace/dma_simple_poll_intp/dma_simple_poll_intp.runs/design_simple_poll_intp_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_simple_poll_intp_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_simple_poll_intp_auto_us_0.tcl
