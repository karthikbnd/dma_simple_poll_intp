...
HD_PWD='C:/Users/kab/Desktop/workspace/dma_simple_poll_intp/dma_simple_poll_intp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_simple_poll_intp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_simple_poll_intp_wrapper.tcl -notrace
